 ...
 * 
 */
package cz.uhk.herman.pgrf3.renderer;

import java.util.Vector;

import cz.uhk.herman.pgrf3.transforms.Col;
import cz.uhk.herman.pgrf3.transforms.Point3D;
import cz.uhk.herman.pgrf3.transforms.Vec1D;
...
public class Renderer {
	...
	void clipHomo(VVector av1, VVector av2, VVector av3) {
		...
		//TODO - set��dit podle W a ud�lat nov� podm�nky
		...
		if(p2.w > wmin){
			//dva body jsou vid�t => vytvo�it novej troj�heln�k
		...
		if(p1.w > wmin){
			//jeden je vid�t
			//System.out.println("Jeden vid�t");
			VVector v1 = new VVector();
			...
			//nen� vid�t
			//System.out.println("Nen� vid�t");
		}
		
		//pokud se m� ud�lat novej troj�heln�k va = v1.mul(1-t).add(v2.mil(t));
	...
	void rasterizeTriangle(VVector av1, VVector av2, VVector av3) {
		/*
		 * se�adit podle x od bodu nejv�c naho�e
